function useColorTheme(){
    ...
    const parentDiv = "border-5 sm:p-14 lg:p-24 bg-[#e0e0e0] dark:bg-[#303030] lg:w-[80vw] lg:h-[60vh] rounded-tl-[30%] rounded-br-[30%] ";
    ...
    return [redLight, greenLight, choices, mainDiv, parentDiv, moveBtn, quesNumClass, quesClass];
}
